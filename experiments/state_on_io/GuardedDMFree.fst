...
let gdm_cmd1 #cmd1 #cmd2 (#event:Type) (cwp1:cmd_wp cmd1 event) (cwp2:cmd_wp cmd2 event) (c:caller) #r (op:cmd1 r) :
  gdm cmd1 cmd2 event cwp1 cwp2 r (hist_bind (cwp1 c op) (fun ri -> hist_return ri)) =
  Call1 c (CmdR op) Return

let gdm_cmd2 #cmd1 #cmd2 (#event:Type) (cwp1:cmd_wp cmd1 event) (cwp2:cmd_wp cmd2 event) (c:caller) #r (op:cmd2 r) :
  gdm cmd1 cmd2 event cwp1 cwp2 r (hist_bind (cwp2 c op) (fun ri -> hist_return ri)) =
  Call2 c op Return
...
let gdm_guard
  ...
  let m = Call1 Prog (CmdL (GCmd pre)) (Return) in
