...
//[@@ (preprocess_with simplify_qType)]
//lettest () = assert (tgt_pair_of_functions empty == test_pair_of_functions ()) by (trefl ())
...
//[@@ (preprocess_with simplify_qType)]
//lettest_apply_io_bind_identity () =
...
//[@@ (preprocess_with simplify_qType)]
//lettest_apply_io_bind_read_write () =
...
//[@@ (preprocess_with simplify_qType)]
//lettest_apply_io_bind_read_if_write () =
