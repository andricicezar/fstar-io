...
| TyOpenfile :
           ...
           typing g (ECall OOpen e1) (qResexn qFileDescr)
| TyRead :
           #g:typ_env ->
           #e1:exp ->
           $h1:typing g e1 qFileDescr ->
           typing g (ECall ORead e1) (qResexn qString)
| TyWrite :
           #g:typ_env ->
           #e1:exp ->
           #e2:exp ->
           ...
           typing g (ECall OWrite (EPair e1 e2)) (qResexn qUnit)
| TyClose :
           #g:typ_env ->
           #e1:exp ->
           $h1:typing g e1 qFileDescr ->
           typing g (ECall OClose e1) (qResexn qUnit)
| TyStringEq :
           #g:typ_env ->
           #e1:exp ->
           #e2:exp ->
