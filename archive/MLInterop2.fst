...
noeq
type is_ml : Type0 -> Type u#1 =
| ML_unit : is_ml unit
| ML_bool : is_ml bool
| ML_int : is_ml int
| ML_string : is_ml string
| ML_pair : a:Type0 -> b:Type0 -> is_ml a -> is_ml b -> is_ml (a*b)
| ML_arrow : a:Type0 -> b:Type0 -> is_ml a -> is_ml b -> is_ml (a -> ML b)
...
class exportable (t : Type) = { etype : mlish; export : t -> etype }
class importable (t : Type) = { itype : mlish; import : itype -> Ex t }

let mk_exportable (#t1:Type) (t2 : mlish) (exp : t1 -> t2) : exportable t1 =
  { etype = t2; export = exp }

let mk_importable (t1:mlish) (#t2 : Type) (imp : t1 -> Ex t2) : importable t2 =
  { itype = t1; import = imp }

// instance ml_exportable (#t : Type) (d : exportable t) : is_ml (d.etype) = FStar.Squash.return_squash Refl
// instance ml_importable (#t : Type) (d : importable t) : is_ml (d.itype) = ()

instance exportable_ml (t:mlish) : exportable t = mk_exportable t (fun x -> x)
instance importable_ml (t:mlish) : importable t = mk_importable t (fun x -> x)
...
instance exportable_pair (t1 t2:mlish) [| d1:exportable t1 |] [| d2:exportable t2 |] : exportable (t1 * t2) =
