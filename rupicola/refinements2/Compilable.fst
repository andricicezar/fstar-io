...
let test2_var
  ...
  = CVarShrink1 _ _ _ _ (CVar _ _ _)

let test4_exp'
  : compilable_closed #(unit -> unit -> unit -> unit) (fun x y z -> y)
  = CLambda _ _ _ _ (CLambda _ _ _ _ (CLambda _ _ _ _ (CVarShrink1 _ _ _ _ (CVar _ _ _))))

let test1_hoc
  : compilable_closed #((bool -> bool) -> bool) (fun f -> f false)
  = CLambda _ _ _ _ (CApp _ _ _ _ (CFalse _) _ (CVar _ _ _))

let test2_if
  : compilable_closed #(bool -> bool) (fun x -> if x then false else true)
  = CLambda _ _ _ _ (CIf _ _ _ (CVar _ _ _) _ (CFalse _) _ (CTrue _))

let test1_if
  : compilable_closed #(bool -> bool -> bool) (fun x y -> if x then false else y)
  = CLambda _ _ _ _ (CLambda _ _ _ _ (CIf _ _ _ (CVarShrink1 _ _ _ _ (CVar _ _ _)) _ (CFalse _) _ (CVar _ _ _)))
