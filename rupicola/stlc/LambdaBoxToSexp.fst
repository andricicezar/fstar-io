...
and serialize_fixpoint_defs (defs: list (name & term)) : Tot (list sexp) (decreases defs) =
  match defs with
  | [] -> []
  | (n, body) :: rest ->
      slist [raw "def"; serialize_name n; serialize_term body] :: serialize_fixpoint_defs rest
