...
val lem_backtranslate g (e:exp{fv_in_env g e}) t (h:typing g e t) (#fs_tr:list fs_event) (#tr:list event) : Lemma
(equiv #g #fs_tr #tr t (backtranslate g e t h) e)
let rec lem_backtranslate g e t (h:typing g e t) (#fs_tr) (#tr) =
   match e with
  | EUnit -> equiv_unit g #fs_tr #tr
  | EVar x -> equiv_var g x #fs_tr #tr
  | EApp e1 e2 ->
    let TyApp #_ #_ #_ #t1 #t2 h1 h2 = h in
    lem_app_fv_in_env g e1 e2;
    lem_backtranslate g e1 (t1 ^-> t2) h1 #fs_tr #tr;
    lem_backtranslate g e2 t1 h2 #fs_tr #tr;
    let fs_e1 = (backtranslate g e1 (t1 ^-> t2) h1) in
    let fs_e2 = (backtranslate g e2 t1 h2) in
    equiv_app #g #fs_tr #tr fs_e1 fs_e2 e1 e2
  | ELam body -> admit ()
    (*let TyLam #_ #body #t1 #t2 hbody = h in
    lem_lam_fv_in_env g body t1;
    lem_backtranslate (extend t1 g) body t2 hbody #fs_tr #tr;
  ...
  | ETrue -> equiv_true g #fs_tr #tr
  | EFalse -> equiv_false g #fs_tr #tr
  | EIf e1 e2 e3 ->
    let TyIf #_ #_ #_ #_ #t h1 h2 h3 = h in
    lem_if_fv_in_env g e1 e2 e3;
    lem_backtranslate g e1 qBool h1 #fs_tr #tr;
    lem_backtranslate g e2 t h2 #fs_tr #tr;
    lem_backtranslate g e3 t h3 #fs_tr #tr;
    let fs_e1 = (backtranslate g e1 qBool h1) in
    let fs_e2 = (backtranslate g e2 t h2) in
    let fs_e3 = (backtranslate g e3 t h3) in
    equiv_if #g #fs_tr #tr fs_e1 fs_e2 fs_e3 e1 e2 e3
  | EPair e1 e2 ->
    let TyPair #_ #_ #_ #t1 #t2 h1 h2 = h in
    lem_pair_fv_in_env g e1 e2;
    lem_backtranslate g e1 t1 h1 #fs_tr #tr;
    lem_backtranslate g e2 t2 h2 #fs_tr #tr;
    let fs_e1 = (backtranslate g e1 t1 h1) in
    let fs_e2 = (backtranslate g e2 t2 h2) in
    equiv_pair #g #fs_tr #tr fs_e1 fs_e2 e1 e2
  | EFst e12 ->
    let TyFst #_ #_ #t1 #t2 h1 = h in
    lem_fst_fv_in_env g e12;
    lem_backtranslate g e12 (t1 ^* t2) h1 #fs_tr #tr;
    let fs_e12 = (backtranslate g e12 (t1 ^* t2) h1) in
    equiv_pair_fst_app #g #fs_tr #tr fs_e12 e12
  | ESnd e12 ->
    let TySnd #_ #_ #t1 #t2 h1 = h in
    lem_snd_fv_in_env g e12;
    lem_backtranslate g e12 (t1 ^* t2) h1 #fs_tr #tr;
    let fs_e12 = (backtranslate g e12 (t1 ^* t2) h1) in
    equiv_pair_snd_app #g #fs_tr #tr fs_e12 e12
#pop-options
