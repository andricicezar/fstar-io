...
(** The free monad has two command channels with independent universes.
    ...
    universes without universe-lifting wrappers: each command type goes on
    the channel matching its index universe. *)
noeq
type free (cmd1 : Type u#i -> Type u#j) (cmd2 : Type u#f -> Type u#g) (a:Type u#a)
  : Type u#(max (1 + i) (max (1 + f) (max j (max g a)))) =
| Call1 : #r:Type u#i -> cmd1 r -> cont:(r -> free cmd1 cmd2 a) -> free cmd1 cmd2 a
| Call2 : #r:Type u#f -> cmd2 r -> cont:(r -> free cmd1 cmd2 a) -> free cmd1 cmd2 a
